...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="product-add.php" class="btn btn-primary btn-sm">Thêm Hàng</a>
	</div>
</section>
					...
					<table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th width="60">Giá hàng</th>
								<th width="60">Số lượng tồn kho</th>
								<th>Loại Hàng</th>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td style="width:130px;"><img src="../<?php echo $row['p_featured_photo']; ?>" alt="<?php echo $row['p_name']; ?>" style="width:100px;"></td>
									<td><?php echo $row['p_name']; ?></td>
									<td><?php echo number_format(num: $row['p_current_price']); ?> VNĐ</td>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Liệu bạn muốn xoá mặt hàng này?</p>
			</div>
