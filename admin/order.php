                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr class="<?php if ($row['payment_status'] == 'Pending') {
                                    ...
                                    <td><?php echo $i; ?></td>
                                    <td>
                                        <b>Mã khách:</b> <?php echo $row['customer_id']; ?><br>
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#model-<?php echo $i; ?>"
                                            class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Nhắn
                                            tin</a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" style="font-weight: bold;">Nhắn tin</h4>
                                                    </div>
                                                    <div class="modal-body" style="font-size: 14px">
                                                        <form action="" method="post">
                                                            ...
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tr>
                                                                    <td></td>
                                                                    <td><input type="submit" value="Nhắn tin" name="form1">
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </form>
                                    ...
                                    <td>
                                        ...
                                        foreach ($result1 as $row1) {
                                            echo '<b>Tên hàng:</b> ' . $row1['product_name'];
                                            echo '<br>(<b>Số lạng:</b> ' . $row1['quantity'];
                                    ...
                                    <td><?php echo number_format($row['paid_amount'], 2, '.', ','); ?> VNĐ</td>
                                    <td>
