...
if (isset($_POST['form1'])) {
	...
	if ($valid == 1) {
		...
		move_uploaded_file($path_tmp, '../asset/img/' . $final_name);
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="ecat_id" class="form-control select2 end-cat">
									...
									foreach ($result as $row) {
										// Gán class cho mỗi end-cat dựa trên mcat_id
										echo '<option value="' . $row['ecat_id'] . '" class="ecat mcat-' . $row['mcat_id'] . '" style="display:none;">' . $row['ecat_name'] . '</option>';
									}
									?>
								</select>
							</div>
