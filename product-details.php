    ...
    <div class="bg-white rounded-lg shadow-xl overflow-hidden max-w-6xl w-full zoom250">
        <div class="md:flex">
            <div class="md:flex-shrink-0">
                ...
                ?>
                <img class="h-96 w-full object-cover md:w-96" src="<?php echo htmlspecialchars($imagePath); ?>"
            ...
            <div class="p-8">
                ...
                <div class="mt-6">
                    <div class="flex items-center">
                        <span
                            class="text-2xl font-bold text-gray-900"><?php echo formatPrice($product['p_current_price']); ?></span>
                    </div>
                ...
                <div class="mt-8 space-y-4">
                    ...
                    <form method="POST" action="">
                        ...
                        <button type="submit" name="buy_now"
                            class="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded flex items-center justify-center">
